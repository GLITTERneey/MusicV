...
💭 [{BOT_NAME}](https://t.me/{BOT_USERNAME}) **ᴍᴇᴍᴜɴɢᴋɪɴᴋᴀɴ ᴀɴᴅᴀ ᴜɴᴛᴜᴋ ᴍᴇᴍᴜᴛᴀʀ ᴍᴜsɪᴋ ᴘᴀᴅᴀ ɢʀᴜᴘ ᴍᴇʟᴀʟᴜɪ ᴏʙʀᴏʟᴀɴ sᴜᴀʀᴀ ʏᴀɴɢ ʙᴀʀᴜ ᴅɪ ᴛᴇʟᴇɢʀᴀᴍ
━━━━━━━━━━━━━━━
ɢᴜɴᴀᴋᴀɴ ᴘᴇʀɪɴᴛᴀʜ » /commands « ᴜɴᴛᴜᴋ ᴍᴇɴɢᴇᴛᴀʜᴜɪ ғɪᴛᴜʀ ʟᴇɴɢᴋᴀᴘ ɴʏᴀ ʙᴏᴛ ᴍᴜsɪᴄ**
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url="https://t.me/hiroshisupport"
                    )
                ],
            ]
        ),
