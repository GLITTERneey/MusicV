...
async def pause(client, m: Message):
    ...
    if chat_id in QUEUE:
        ...
        await m.reply("❌ **𝐭𝐢𝐝𝐚𝐤 𝐚𝐝𝐚 𝐝𝐚𝐥𝐚𝐦 𝐬𝐭𝐫𝐞𝐚𝐦𝐢𝐧𝐠**")
...
async def change_volume(client, m: Message):
    ...
    try:
        ...
        await m.reply(f"✅ **𝐯𝐨𝐥𝐮𝐦𝐞 𝐝𝐢𝐬𝐞𝐭𝐞𝐥 𝐤𝐞** `{range}`%")
    except Exception as e:
        await m.reply(f"🚫 **error:**\n\n{e}")
